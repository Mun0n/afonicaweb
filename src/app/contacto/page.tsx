  ...
  return (
    <div className="min-h-screen bg-black text-white py-8 md:py-12">
      <div className="container mx-auto px-4 max-w-3xl">
        <h1 className="text-4xl md:text-6xl font-bold mb-4 text-center text-brand-orange">
          Contacto
        </h1>
        ...
        <div className="space-y-6">
          ...
          <Link href="mailto:contratacion@nebularproducciones.com" className="block">
            <div className="bg-zinc-900 p-4 rounded-lg border border-zinc-800/50 hover:border-brand-orange/50 transition-colors group">
              <h2 className="text-2xl md:text-3xl font-bold mb-2 text-brand-orange">
          ...
          {/* Social Media */}
          <div className="bg-zinc-900 p-4 rounded-lg border border-zinc-800/50 hover:border-brand-orange/50 transition-colors">
            <h2 className="text-2xl md:text-3xl font-bold mb-2 text-brand-orange">
              📲 Redes Sociales
            </h2>
